...
function GreenButton({ children, className = '', onClick, type= 'button', disabled=false }: buttonProps) {

  const buttonClass = "w-[157px] h-[56px] rounded-[8px] text-white text-center bg-[#54e03e] " + className
...
export { BlueButton, WhiteButton, GreenButton };